...
function a(e) {
  return e.type === w ? "Fragment" : "function" == typeof e.type ? e.type.displayName || e.type.name : "string" == typeof e.type ? e.type : "#text";
}
var i = [];
var s = [];
function c() {
...
var l2 = false;
function u(e) {
  return "function" == typeof e.type && e.type != w;
}
function f(n) {
...
` + f(this.__v)), b.call(this, n);
  ...
  var n = false, t = l.__b, r2 = l.diffed, c2 = l.vnode, l3 = l.__r, v2 = l.__e, b2 = l.__, g = l.__h, E = p ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, k2 = [];
  l.__e = function(n2, e, t2, o2) {
    ...
    var r3 = e.type;
    if (n = true, void 0 === r3)
      throw new Error("Undefined component passed to createElement()\n\nYou likely forgot to export your component or might have mixed up default and named imports" + w2(e) + "\n\n" + f(e));
  ...
  l.vnode = function(n2) {
    ...
    if (e.__k && e.__k.forEach(function(n2) {
      ...
      var s2 = h(i2);
      if ("" !== s2)
        "table" === o2 && "td" !== s2 && y(s2) ? (console.log(s2, i2.__e), console.error("Improper nesting of table. Your <table> should not have a table-node parent." + w2(e) + "\n\n" + f(e))) : "thead" !== o2 && "tfoot" !== o2 && "tbody" !== o2 || "table" === s2 ? "tr" === o2 && "thead" !== s2 && "tfoot" !== s2 && "tbody" !== s2 && "table" !== s2 ? console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot/table> parent." + w2(e) + "\n\n" + f(e)) : "td" === o2 && "tr" !== s2 ? console.error("Improper nesting of table. Your <td> should have a <tr> parent." + w2(e) + "\n\n" + f(e)) : "th" === o2 && "tr" !== s2 && console.error("Improper nesting of table. Your <th> should have a <tr>." + w2(e) + "\n\n" + f(e)) : console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent." + w2(e) + "\n\n" + f(e));
      else if ("p" === o2) {
        var c3 = d(e).filter(function(n2) {
          return m.test(n2);
        });
        c3.length && console.error("Improper nesting of paragraph. Your <p> should not have " + c3.join(", ") + "as child-elements." + w2(e) + "\n\n" + f(e));
      }
    }
        ...
        for (var g2 = 0; g2 < b3.length; g2 += 1) {
          ...
          if (E2.__H) {
            for (var k3 = 0; k3 < E2.__H.length; k3++)
              if ((t2 = E2.__H[k3]) != t2) {
                var _2 = a(e);
                throw new Error("Invalid argument passed to hook. Hooks should not be called with NaN in the dependency array. Hook index " + g2 + " in component " + _2 + " was called with NaN.");
              }
          }
        }
    }
...
//# sourceMappingURL=chunk-MK3AE27I.js.map
